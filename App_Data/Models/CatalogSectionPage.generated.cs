...
namespace Umbraco.Web.PublishedContentModels
{
	...
	[PublishedContentModel("CatalogSectionPage")]
	public partial class CatalogSectionPage : PublishedContentModel, IBasicInfoComponent, INavigationComponent, ISeoComponent
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "CatalogSectionPage";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public CatalogSectionPage(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<CatalogSectionPage, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}

		///<summary>
		/// Глобальная стоимость гравировки
		///</summary>
		[ImplementPropertyType("globalEngravingCost")]
		public string GlobalEngravingCost
		{
			get { return this.GetPropertyValue<string>("globalEngravingCost"); }
		}
